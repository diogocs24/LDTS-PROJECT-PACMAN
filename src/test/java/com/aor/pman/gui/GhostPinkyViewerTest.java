...
public class GhostPinkyViewerTest {
    ...
    public void testDraw() {
        ...
        // Create a new GhostPinkyViewer instance
        GhostPinkyViewer viewer = new GhostPinkyViewer();

        // Call the draw method
        viewer.draw(ghost, gui);

        // Verify that the GUI's drawGhosts method was called with the correct arguments
        verify(gui).drawGhosts(new Position(5, 10), "#FFC0CB");
    }
}
